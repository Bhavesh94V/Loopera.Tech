...
const CanvasWrapper = ({ children }: { children: React.ReactNode }) => (
  <Canvas gl={{ alpha: true }} dpr={[1, 2]} frameloop="always" className="w-full h-full relative pointer-events-none">
    {children}
  </Canvas>
)
...
const Beams = ({
  ...
  return (
    <CanvasWrapper>
      ...
      {!transparentBg ? <color attach="background" args={["#000000"]} /> : null}
