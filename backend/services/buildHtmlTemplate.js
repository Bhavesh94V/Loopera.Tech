  ...
  <html lang="en">
    ...
    <body style="font-family:Inter,system-ui,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:#f3f4f6;margin:0;padding:24px;">
      <div style="max-width:700px;margin:0 auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08)">
        ...
        <!-- Header -->
        <div style="background:${primary};padding:0px 24px 0px 0px;display:flex;align-items:center;justify-content:space-between;">
          <img src="${logoUrl}" alt="Loopera Tech" style="height:75px;object-fit:contain;display:block;background-color:${light};" />
          <span style="color:white;font-weight:600;font-size:24px;padding:18px 24px;">${title}</span>
        </div>
